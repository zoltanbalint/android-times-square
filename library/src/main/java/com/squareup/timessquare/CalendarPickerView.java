...
public class CalendarPickerView extends ListView {
    ...
    private DateHighlightableFilter dateHighlightableFilter;
    ...
    public CalendarPickerView(Context context, AttributeSet attrs) {
        ...
        titleTextColor = a.getColor(R.styleable.CalendarPickerView_titleTextColorTs,
    ...
    private boolean isDateHighlightable(Date date) {
        return dateHighlightableFilter == null || dateHighlightableFilter.isDateHighlightable(date);
    }
    ...
    /**
     * Set a listener used to discriminate between highlightable dates. Set this to
     * disable arbitrary dates as they are rendered. Similar to #setDateSelectableFilter(DateSelectableFilter)
     * <p/>
     * Important: set this before you call {@link #init(Date, Date)} methods.  If called afterwards,
     * it will not be consistently applied.
     */
    public void setDateHighlightableFilter(DateHighlightableFilter listener) {
        dateHighlightableFilter = listener;
    }
    ...
    /**
     * Interface used for determining the highlightability of a date cell
     *
     * @see #setDateHighlightableFilter(DateHighlightableFilter)
     */
    public interface DateHighlightableFilter {
        boolean isDateHighlightable(Date date);
    }
